...
EXECUTE REINUS.migrar_almacen
EXECUTE REINUS.migrarConcepto
EXECUTE REINUS.migrar_Factura
EXECUTE REINUS.migrar_Factura
EXECUTE REINUS.migrar_Detalle_Factura
EXECUTE REINUS.migrar_marca
EXECUTE REINUS.migrar_modelo
EXECUTE REINUS.migrar_rubro
EXECUTE REINUS.migrar_subrubro
...
END CATCH
   ...
   IF (EXISTS (SELECT 1 FROM REINUS.Localidad)
   AND EXISTS (SELECT 1 FROM REINUS.Provincia)
   AND EXISTS (SELECT 1 FROM REINUS.Usuario)
   AND EXISTS (SELECT 1 FROM REINUS.Cliente)
   AND EXISTS (SELECT 1 FROM REINUS.Vendedor)
   AND EXISTS (SELECT 1 FROM REINUS.Detalle_Factura)
   AND EXISTS (SELECT 1 FROM REINUS.Factura)
   AND EXISTS (SELECT 1 FROM REINUS.Venta)
   AND EXISTS (SELECT 1 FROM REINUS.Detalle_VENTA)
   AND EXISTS (SELECT 1 FROM REINUS.Rubro)
   AND EXISTS (SELECT 1 FROM REINUS.SubRubro)
   AND EXISTS (SELECT 1 FROM REINUS.Modelo)
   AND EXISTS (SELECT 1 FROM REINUS.Marca)
   AND EXISTS (SELECT 1 FROM REINUS.Direccion)
   AND EXISTS (SELECT 1 FROM REINUS.Domicilio)
   AND EXISTS (SELECT 1 FROM REINUS.Envio)
   AND EXISTS (SELECT 1 FROM REINUS.Tipo_Envio)

   AND EXISTS (SELECT 1 FROM REINUS.Concepto)
   AND EXISTS (SELECT 1 FROM REINUS.Almacen)
   AND EXISTS (SELECT 1 FROM REINUS.Detalle_Pago)
   AND EXISTS (SELECT 1 FROM REINUS.MedioPago)
   AND EXISTS (SELECT 1 FROM REINUS.Pago)
   AND EXISTS (SELECT 1 FROM REINUS.Producto)
   AND EXISTS (SELECT 1 FROM REINUS.Publicacion)
   )
   BEGIN
