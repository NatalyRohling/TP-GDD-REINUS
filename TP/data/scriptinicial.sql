...
ALTER TABLE REINUS.Cliente NOCHECK CONSTRAINT ALL;
ALTER TABLE REINUS.Direccion NOCHECK CONSTRAINT ALL;
ALTER TABLE REINUS.Domicilio NOCHECK CONSTRAINT ALL;
ALTER TABLE REINUS.Envio NOCHECK CONSTRAINT ALL;
ALTER TABLE REINUS.Localidad NOCHECK CONSTRAINT ALL;
ALTER TABLE REINUS.Provincia NOCHECK CONSTRAINT ALL;
ALTER TABLE REINUS.Usuario NOCHECK CONSTRAINT ALL;
ALTER TABLE REINUS.Vendedor NOCHECK CONSTRAINT ALL;
ALTER TABLE REINUS.Venta NOCHECK CONSTRAINT ALL;
...
CREATE PROCEDURE REINUS.migrar_provincia 
AS 
BEGIN 
...
CREATE PROCEDURE REINUS.migrar_Localidad
AS 
BEGIN 
...
WHERE M.ALMACEN_CALLE IS NOT NULL 
  ...
  */
  ...
  CREATE PROCEDURE REINUS.migrar_direccion_y_domicilio
AS
BEGIN
...
CREATE PROCEDURE REINUS.migrarAlmacen AS
BEGIN
...
GO
-------------------------MIGRACION DE MODELO ----------------------------
CREATE PROCEDURE migrarModelo AS
BEGIN
...
SELECT DISTINCT PRODUCTO_SUB_RUBRO  AS PRODUCTO_SUB_RUBRO,RUBRO_ID
FROM gd_esquema.Maestra
JOIN REINUS.Rubro on PRODUCTO_RUBRO_DESCRIPCION = PRODUCTO_RUBRO_DESCRIPCION --creo que le psuimos en si el mismo nombre
WHERE PRODUCTO_SUB_RUBRO IS NOT NULL
--asi deberia matchear el subruo con rubro
