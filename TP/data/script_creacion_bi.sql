...
BEGIN
	...
	JOIN JOIN REINUS.Producto pro ON p.PRODUCTO_ID = pro.ID_PRODUCTO
    JOIN REINUS.RUBRO ON 
    JOIN 
        REINUS.BI_SUBRUBRO SR ON p.SUBRUBRO_ID = SR.ID_SUBRUBRO -- 
    JOIN 
        REINUS.BI_RUBRO R ON SR.RUBRO_ID = R.ID_RUBRO 
